...
with tab2:
    ...
    st.image('distri_kai_new.png', caption='Distribusi Jumlah Ulasan Sesuai Sentimen')
    st.write('Pada Gambar di atas memperlihatkan dataset yang berisi ulasan aplikasi access by kai dari user sejumlah 1372 ulasan terbagi menjadi 1035 ulasan negatif dan 337 ulasan positif. Data ini nantinya akan dipisah menjadi data latih dan data uji. Pada penelitian ini dataset akan dipecah dalam bentuk 90% data latih dan 10% data uji.')
    st.write('')
    st.write('**Hasil Uji:**')
